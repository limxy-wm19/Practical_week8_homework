...
public class MainActivity extends AppCompatActivity {
    ...
    static final String NIGHT_BACKGROUND = "background";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        night_mode = mPreferences.getInt(NIGHT_BACKGROUND, night_mode);
    ...
    protected void onPause(){
        ...
        preferencesEditor.putInt(NIGHT_BACKGROUND, night_mode);
